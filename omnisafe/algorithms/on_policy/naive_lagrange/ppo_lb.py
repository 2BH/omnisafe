...
# ==============================================================================
"""Implementation of the Linear Approximated Log Barrier Function version of the PPO algorithm."""
...
@registry.register
class PPOLB(PPO):
    """The Log Barrier version of the PPO algorithm.

    A simple combination of the approximated log barrier function and the Proximal Policy Optimization algorithm.
    """

    def _init(self) -> None:
        """Initialize the PPOLB specific model.
